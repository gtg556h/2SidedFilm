...
def process(baseDirectory, outFilename, side, pivN, nFrames, dt):
    ...
    np.savez(outFilename, x=x, y=y, ux1=ux1, uy1=uy1, mag1=mag1, ang1=ang1, p1=p1, ux2=ux2, uy2=uy2, mag2=mag2, p2=p2, ux0=ux0, uy0=uy0, mag0=mag0, side=side, pivN=pivN, nFrames=nFrames, dt=dt)
